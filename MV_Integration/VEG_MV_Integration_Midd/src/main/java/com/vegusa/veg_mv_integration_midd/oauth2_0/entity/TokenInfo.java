...
public class TokenInfo
{
    ...
    public void setCipherAccessToken(String cipher_access_token){
        this.cipher_access_token = cipher_access_token;
        int aux = cipher_access_token.length();

...
public interface ProductsRepository extends JpaRepository<Products, Long> {
    ...
    @Query(value = "select * from product where PartNumber = :partNumber and DataAreaId = :dataAreaId limit 1", nativeQuery = true)
    Optional<Products> getProductByNumber(@Param("partNumber") String partNumber, @Param("dataAreaId") String dataAreaId);
}
